...
def main():
    write_square_paths_to_pt(num_origins=2000, filename="square_paths_top.pt")
    visualize_square_paths_from_file("square_paths_top.pt", num_paths=5)
